...
class ThriftInterface(BaseTest):
    ...
    def getPlatform(self):
        ...
        if "platform" in self.test_params: 
            self.platform = self.test_params['platform']
        else:
            exit("No platform info "
                 "please specify 'platform' as test parameter.")
